...
Collection of Codex / multi-agent skills published to [skills.sh](https://skills.sh).
...
### Install this repo's skills globally to Codex

```bash
~/.nvm/versions/node/v22.21.1/bin/npx skills add vladmdgolam/agent-skills -g -a Codex -y
```

### Install a specific skill

```bash
~/.nvm/versions/node/v22.21.1/bin/npx skills add vladmdgolam/agent-skills --skill time-lens -g -a Codex -y
```
...
4. Commit and push
5. Install globally: `~/.nvm/versions/node/v22.21.1/bin/npx skills add vladmdgolam/agent-skills --skill <name> -g -a Codex -y`
